...
def main() -> None:
    ...
    parser.add_argument("--config", 
                        default="configs/exp/Blackbird/codenet.conf",
                        help="Path to model configuration file")
    parser.add_argument("--ckpt", 
                        default="experiments/Blackbird/codenet/ckpt/best_model.ckpt",
                        help="Path to trained checkpoint file")
    
    # Output paths
    parser.add_argument("--onnx", 
                        default="experiments/Blackbird/codenet/airimu_cpu_fp32.onnx",
                        help="Output path for ONNX model")
    parser.add_argument("--torch", 
                        default="experiments/Blackbird/codenet/airimu_cpu_fp32.pt",
