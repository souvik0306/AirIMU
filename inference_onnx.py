...
def main() -> None:
    ...
    parser.add_argument("--seqlen", type=int, default=1000, help="IMU sequence length for chunked inference")
    parser.add_argument("--whole", action="store_true", help="Process entire sequences in one shot")
