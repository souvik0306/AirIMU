...
def main() -> None:
    ...
    parser.add_argument("--onnx", default="experiments/euroc/codenet/airimu_euroc.onnx",
                        help="Output ONNX file")
    parser.add_argument("--torch", default="experiments/euroc/codenet/airimu_euroc.pt",
